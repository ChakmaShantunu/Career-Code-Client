                    ...
                    <div className="flex justify-center gap-3 pt-2">
                        <button className="btn btn-ghost btn-sm btn-square rounded-full hover:bg-primary/10 hover:text-primary">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M20 6h-3V4a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v2H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2ZM9 4h6v2H9V4Zm11 4v3h-7V9h-2v2H4V8h16ZM4 18v-5h7v1h2v-1h7v5H4Z" />
                            </svg>
                        </button>
                        <button className="btn btn-ghost btn-sm btn-square rounded-full hover:bg-primary/10 hover:text-primary">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
